...
|:--|:--|:--|
|[v0.4.10](https://github.com/s-yamano/Splunk-COVID19-Japan/releases/tag/v0.4.10.1)	|2020/05/31	|"COVID19 Japan" ダッシュボードに実効再生産数グラフを追加<br />"COVID19 Japan (specific prefecture)" ダッシュボードに実効再生産数グラフを追加
